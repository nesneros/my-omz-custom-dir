...
# ORIGINAL: https://raw.githubusercontent.com/caarlos0/dotfiles/master/macos/set-defaults.sh
...
echo ""
echo "› Dock"
echo "  › Setting the icon size of Dock items to 60 pixels for optimal size/screen-realestate"
